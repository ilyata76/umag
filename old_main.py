...
from spindynapy.core import constants  # type: ignore # noqa
...
from spindynapy.core.types import Material, UniaxialAnisotropy  # type: ignore # noqa
from spindynapy.unit import XYZ, nano, femto  # type: ignore # noqa
from spindynapy.matlib import material_registry, mat_lib  # type: ignore # noqa
...
if __name__ == "__main__":
    ...
    # print(f"Использовано: {mem.used / 1024**3:.2f} ГБ")
    ...
    # print(f"Загрузка по ядрам: {cpu_per_core}")

    # aaa = psutil.Process()
    # print(f"Использование памяти текущим процессом: {aaa.memory_info().rss / 1024**2:.2f} МБ")

    # swap = psutil.swap_memory()
    # print(f"Swap использовано: {swap.used / 1024**3:.2f} ГБ из {swap.total / 1024**3:.2f} ГБ")
